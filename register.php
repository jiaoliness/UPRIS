	...
	<form action="register.php" method="post"> 
		<div id="nameonePan">
			<ul>
                ...
                <li><label for="password2">Confirm Password:</label>  <span id="txtHintP2"></span></li>
				<li><label for="field">Field of Research:</label></li>
				<li><label for="ins">Institute:</label>  <span id="txtHintI"></span></li>
                <li><label for="number">Registration Number: </label>   <span id="txtHintN"></span></li>
        	</ul>
		</div>
