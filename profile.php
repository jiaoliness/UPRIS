...
<?php
 ...
 proposal_class::view_proposals($sesid,"status='new'");
 proposal_class::view_proposals($sesid,"status='pending'"); 
  proposal_class::view_proposals($sesid,"status='approved'");
  proposal_class::view_proposals($sesid,"status='declined'");
 ?> 
